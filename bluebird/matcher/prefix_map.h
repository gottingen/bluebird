...
#ifndef BLUEBIRD_MATCHER_PREFIX_MAP_H_
#define BLUEBIRD_MATCHER_PREFIX_MAP_H_
...
#include "bluebird/matcher/trie/cedar.h"
...
#endif
    public:
        explicit PrefixMap(const std::map<std::string, int> &dic);
...
#endif  // BLUEBIRD_MATCHER_PREFIX_MAP_H_
