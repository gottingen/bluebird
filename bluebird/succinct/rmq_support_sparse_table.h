...
/*! \file rmq_support_sparse_table.h
    \brief rmq_support_sparse_table.h contains the class rmq_support_sparse_table.
    \author Simon Gog
*/
 ...
 */
    ...
    public:
            ...
            for (size_type i = 1; i < k; ++i) {
                for (size_type j = 0; j < m_table[i].size(); ++j) {
                    m_table[i][j] = mm_trait::compare((*m_v)[j + m_table[i - 1][j]],
                                    ...
                                    ? m_table[i - 1][j] : (1ULL << i) + m_table[i - 1][j + (1ULL << i)];
                }
            }
        }
        ...
        size_type operator()(const size_type l, const size_type r) const {
            ...
            return mm_trait::compare((*m_v)[l + m_table[k - 1][l]], (*m_v)[rr + m_table[k - 1][rr]]) ? l +
                                                                                                       m_table[k - 1][l]
                                                                                                     : rr + m_table[k -
                                                                                                                    1][rr];
        }
