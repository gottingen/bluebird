...
/*!\file bit_vector_il.h
   \brief bit_vector_il.h contains the bluebird::bit_vector_il class, and
          classes which support rank and select for bit_vector_il.
   \author Matthias Petri, Simon Gog
*/
#ifndef BLUEBIRD_SUCCINCT_BIT_VECTOR_IL_H_
#define BLUEBIRD_SUCCINCT_BIT_VECTOR_IL_H_
...
#endif  // BLUEBIRD_SUCCINCT_BIT_VECTOR_IL_H_
