...
/*! \file csa_wt.h
    \brief csa_wt.h contains an implementation of the compressed suffix array based on a wavelet tree.
    \author Simon Gog
*/
...
#include "suffix_array_helper.h"
#include "iterators.h"
#include "util.h"
#include "fast_cache.h"
#include "csa_sampling_strategy.h"
#include "csa_alphabet_strategy.h"
#include <iostream>
...
/*!
  ...
  *
  *  \sa bluebird::csa_sada, bluebird::csa_bitcompressed
  * @ingroup csa
 */
...
// == template functions ==
    ...
    template<class t_wt, uint32_t t_dens, uint32_t t_inv_dens, class t_sa_sample_strat, class t_isa, class t_alphabet_strat>
    inline auto csa_wt<t_wt, t_dens, t_inv_dens, t_sa_sample_strat, t_isa, t_alphabet_strat>::operator[](
    ...
    template<class t_wt, uint32_t t_dens, uint32_t t_inv_dens, class t_sa_sample_strat, class t_isa, class t_alphabet_strat>
    auto csa_wt<t_wt, t_dens, t_inv_dens, t_sa_sample_strat, t_isa, t_alphabet_strat>::operator=(
            const csa_wt<t_wt, t_dens, t_inv_dens, t_sa_sample_strat, t_isa, t_alphabet_strat> &csa) -> csa_wt & {
        if (this != &csa) {
            copy(csa);
        }
        return *this;
    ...
    template<class t_wt, uint32_t t_dens, uint32_t t_inv_dens, class t_sa_sample_strat, class t_isa, class t_alphabet_strat>
    auto csa_wt<t_wt, t_dens, t_inv_dens, t_sa_sample_strat, t_isa, t_alphabet_strat>::operator=(
            csa_wt<t_wt, t_dens, t_inv_dens, t_sa_sample_strat, t_isa, t_alphabet_strat> &&csa) -> csa_wt & {
        if (this != &csa) {
    ...
    template<class t_wt, uint32_t t_dens, uint32_t t_inv_dens, class t_sa_sample_strat, class t_isa, class t_alphabet_strat>
    void csa_wt<t_wt, t_dens, t_inv_dens, t_sa_sample_strat, t_isa, t_alphabet_strat>::swap(
            csa_wt<t_wt, t_dens, t_inv_dens, t_sa_sample_strat, t_isa, t_alphabet_strat> &csa) {
        if (this != &csa) {
