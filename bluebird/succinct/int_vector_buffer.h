...
/*! \file int_vector_buffer.h
    \brief int_vector_buffer.h contains the bluebird::int_vector_buffer class.
...
namespace bluebird {
    ...
    private:
        ...
        bluebird::isfstream m_ifile;
        bluebird::osfstream m_ofile;
    ...
    public:
         ...
         */
        int_vector_buffer(const std::string filename, std::ios::openmode mode = std::ios::in,
                          const uint64_t buffer_size = 1024 * 1024, const uint8_t int_width = t_width,
