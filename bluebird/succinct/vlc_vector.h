...
/*! \file vlc_vector.h
   \brief vlc_vector.h contains a vector which stores the values with variable length codes.
   \author Simon Gog
*/
 ...
 */
    ...
    vlc_vector<t_coder, t_dens, t_width>::operator[](const size_type i) const {
        ...
        return (t_coder::template decode<false, false, int *>(m_z.data(), m_sample_pointer[idx],
                                                              i - t_dens * idx + 1)) - 1;
    }
