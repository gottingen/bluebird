...
/*! \file coder_fibonacci.h
    \brief coder_fibonacci.h contains the class bluebird::coder::fibonacci
	\author Simon Gog
 */
...
namespace bluebird {
    ...
    namespace coder {
        ...
        public:
            ...
            static uint64_t
            decode(const uint64_t *data, const size_type start_idx, size_type n, t_iter it = (t_iter) nullptr);

            template<bool t_sumup, bool t_inc, class t_iter>
            static uint64_t
            decode1(const uint64_t *data, const size_type start_idx, size_type n, t_iter it = (t_iter) nullptr);
            ...
            /*! \sa decode_prefix_sum
              */
            static uint64_t
            decode_prefix_sum(const uint64_t *d, const size_type start_idx, const size_type end_idx, size_type n);
