...
/*! \file sorted_int_stack.h
    \brief sorted_int_stack.h contains a data structure for a stack which can
 ...
 */
                class sorted_int_stack
        {
            ...
            public:
            sorted_int_stack(size_type
            n);
            sorted_int_stack(
            const sorted_int_stack
            &) = default;
            sorted_int_stack(sorted_int_stack && ) =
            default;
            sorted_int_stack & operator =(const sorted_int_stack
            &) = default;
            sorted_int_stack & operator = (sorted_int_stack && ) =
            default;
        ...
        std::string name)const
        {
            ...
            written_bytes += bluebird::serialize(m_overflow, out, child, "overflow");
