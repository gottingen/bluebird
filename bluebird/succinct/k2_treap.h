...
/*! \file k2_treap.h
    \brief k2_treap.h contains a compact k^2-treap.
    \author Simon Gog
*/
...
#include "bluebird/succinct/k2_treap_helper.h"
#include "bluebird/succinct/k2_treap_algorithm.h"
#include <tuple>
#include <algorithm>
#include <climits>
#include <vector>
 ...
 */
    ...
    public:
        ...
        void construct(std::vector<std::tuple<t_x, t_y, t_w>> &v, std::string temp_file_prefix = "") {
            ...
            bluebird::remove(bp_file);
            bluebird::remove(val_file);
        }
