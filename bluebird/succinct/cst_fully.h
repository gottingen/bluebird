...
/*! \file cst_fully.h
    \brief cst_fully.h contains an implementation of Russo et al.'s Fully-Compressed Suffix Tree.
...
#include "vectors.h"
#include "cst_sada.h"
#include "cst_iterators.h"
#include "sdsl_concepts.h"
#include "construct.h"
#include "suffix_tree_helper.h"
#include "suffix_tree_algorithm.h"
 ...
 *                      member `csa`, default class is bluebird::wt).
 ...
 *                      `s_support`, default class is bluebird::bp_support_sada),
 ...
 *                      default class is bluebird::dac_vector),
