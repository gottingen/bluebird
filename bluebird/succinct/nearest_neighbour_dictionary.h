...
/*! \file nearest_neighbour_dictionary.h
    \brief nearest_neighbour_dictionary.h contains a class which supports rank/select for sparse populated bluebird::bit_vectors.
	\author Simon Gog
*/
...
//			std::cerr<<ones<<std::endl;
            ...
            m_differences = int_vector<>(m_ones - m_ones / t_sample_dens, 0,
