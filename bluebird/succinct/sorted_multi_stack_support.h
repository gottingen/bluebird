...
/*! \file sorted_multi_stack_support.h
    \brief sorted_multi_stack_support.h contains a data structure for a stack which contains
 ...
 */
    ...
    inline sorted_multi_stack_support::sorted_multi_stack_support(size_type n) : m_n(n), m_cnt(0), m_top(0), m_stack(),
                                                                                 m_duplication_stack() {
