...
namespace bluebird {
    ...
    void _construct_sa_IS(int_vector<> &text, int_vector<> &sa, std::string &filename_sa, size_t n, size_t text_offset,
        ...
        // Phase 1
        {
            ...
            for (size_t i = 0; i < n; ++i) {
                if (sa[i] > 0 and text[text_offset + sa[i]] <= text[text_offset + sa[i] -
            ...
            // Step 8 - Rename
            for (size_t i = n - number_of_lms_strings + 1, cur_pos = 0, cur_len = 0, last_pos = n - 1, last_len = 1;
                 i < n; ++i) {
                cur_pos = sa[i];
        ...
        if (name + 1 < number_of_lms_strings) {
            ...
            _construct_sa_IS(sa, sa, filename_sa_rec, number_of_lms_strings, n - number_of_lms_strings, name + 1,
                             recursion + 1);
