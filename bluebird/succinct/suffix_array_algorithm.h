...
/*! \file suffix_array_algorithm.h
    \brief suffix_array_algorithm.h contains algorithms on CSAs
    \author Simon Gog
*/
 ...
 */
    ...
    typename csa_wt<>::size_type bidirectional_search_backward(
        ...
        while (begin < it and r_fwd + 1 - l_fwd > 0) {
            --it;
            bidirectional_search(csa_fwd, l_fwd, r_fwd, l_bwd, r_bwd, (typename csa_wt<>::char_type) *it, l_fwd, r_fwd,
                                 l_bwd, r_bwd);
        }
        l_fwd_res = l_fwd;
        r_fwd_res = r_fwd;
 ...
 */
    ...
    bidirectional_search_forward(
        ...
        while (it < end and r_fwd + 1 - l_fwd > 0) {
            bidirectional_search(csa_bwd, l_bwd, r_bwd, l_fwd, r_fwd, (typename csa_wt<>::char_type) *it, l_bwd, r_bwd,
                                 l_fwd, r_fwd);
            ++it;
        }
        l_fwd_res = l_fwd;
