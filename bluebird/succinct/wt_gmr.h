...
/*! \file wt_gmr.h
    \brief wt_gmr.h contains a specialized class to support select, rank
 ...
 */
    ...
    public:
        ...
        //! Constructor
        inv_multi_perm_support(const iv_type *perm, int_vector<> &iv, uint64_t chunksize) : m_perm(perm),
