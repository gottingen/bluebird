...
/*! \file construct_sa.h
    \brief construct_sa.h contains an interface to access suffix array construction algorithms
    \author Simon Gog
*/
...
#include "bluebird/divsufsort/divsufsort.h"
#include "bluebird/divsufsort/divsufsort64.h"

#include "bluebird/succinct/qsufsort.h"

#include "bluebird/succinct/construct_sa_se.h"
#include "bluebird/succinct/construct_config.h"
...
namespace bluebird {
    ...
    namespace algorithm {
        ...
        void calculate_sa(const unsigned char *c, typename int_vector<fixedIntWidth>::size_type len,
                          int_vector<fixedIntWidth> &sa) {
 ...
 */
    ...
    void construct_sa(cache_config &config) {
        ...
        if (t_width == 8) {
            ...
            // call qsufsort
            int_vector<> sa;
            bluebird::qsufsort::construct_sa(sa, cache_file_name(KEY_TEXT, config).c_str(), 0);
            store_to_cache(sa, conf::KEY_SA, config);
        } else {
