...
/*! \file iterators.h
    \brief iterators.h contains an generic iterator for random access containers.
	\author Simon Gog
*/
 ...
 */
    ...
    operator-(const random_access_const_iterator<t_rac> &x, const random_access_const_iterator<t_rac> &y) {
