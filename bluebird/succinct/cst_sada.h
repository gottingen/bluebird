...
/*! \file cst_sada.h
    \brief cst_sada.h contains an implementation of Sadakane's CST.
    \author Simon Gog
*/
...
#include "bluebird/succinct/lcp_support_sada.h"
#include "bluebird/succinct/select_support_mcl.h"
#include "bluebird/succinct/bp_support.h"
#include "bluebird/succinct/bp_support_sada.h"
#include "bluebird/succinct/csa_sada.h" // for std initialization of cst_sada
#include "bluebird/succinct/cst_iterators.h"
#include "bluebird/succinct/cst_sct3.h"
 ...
 *                      bluebird::rank_support_v5)
 * \tparam t_select_10  Type of a select structure for the 2-bit pattern `10`
 *                      (accessible via member \f$bp\_select\_10\f$, default
 *                      class is bluebird::select_support_mcl).
 *
 * It also contains a bluebird::bit_vector which represents the balanced
        ...
        cst_sada(cache_config &config) {
            {
                ...
                bluebird::cst_sct3<> temp_cst(config, true);
        ...
        size_type inv_id(size_type id) {
            if (id < size()) {  // the corresponding node is a leaf
                ...
                while (rb - lb > 1) {
                    ...
                    size_type mid_id = m_bp_support.rank(mid - 1) - m_bp_rank10(
