...
/*! \file csa_sada.h
    \brief csa_sada.h contains an implementation of the compressed suffix array.
    \author Simon Gog
*/
...
/*!
  ...
  *
  *  \sa bluebird::csa_wt, bluebird::csa_bitcompressed
  * @ingroup csa
 */
...
// == template functions ==
    ...
    csa_sada<t_enc_vec, t_dens, t_inv_dens, t_sa_sample_strat, t_isa, t_alphabet_strat>::csa_sada(
        ...
        // calculate psi
        {
            ...
            // TODO: move PSI construct into construct_PSI.h
    ...
    template<class t_enc_vec, uint32_t t_dens, uint32_t t_inv_dens, class t_sa_sample_strat, class t_isa, class t_alphabet_strat>
    auto
    csa_sada<t_enc_vec, t_dens, t_inv_dens, t_sa_sample_strat, t_isa, t_alphabet_strat>::serialize(std::ostream &out,
    ...
    template<class t_enc_vec, uint32_t t_dens, uint32_t t_inv_dens, class t_sa_sample_strat, class t_isa, class t_alphabet_strat>
    void csa_sada<t_enc_vec, t_dens, t_inv_dens, t_sa_sample_strat, t_isa, t_alphabet_strat>::swap(
            csa_sada<t_enc_vec, t_dens, t_inv_dens, t_sa_sample_strat, t_isa, t_alphabet_strat> &csa) {
        if (this != &csa) {
