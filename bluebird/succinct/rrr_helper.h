...
/*! \file rrr_helper.h
   \brief rrr_helper.h contains the bluebird::binomial struct,
 ...
 */
    ...
    struct binomial_coefficients {
        ...
        static struct impl {
            const number_type(&table)[
                    MAX_SIZE + 1][MAX_SIZE + 1] = tBinom::data.table;  // table for the binomial coefficients
