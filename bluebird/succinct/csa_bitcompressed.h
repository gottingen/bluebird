...
/*! \file csa_bitcompressed.h
    \brief csa_bitcompressed.h contains a bitcompressed suffix array.
    \author Simon Gog
*/
...
namespace bluebird {
     ...
     * In contrast to this class, classes like bluebird::csa_sada, and bluebird::csa_wt store
     ...
     * \sa bluebird::csa_sada, bluebird::csa_wt
     * @ingroup csa
     */
