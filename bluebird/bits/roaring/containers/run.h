...
#include "bluebird/bits/roaring/portability.h"
#include "bluebird/bits/roaring/roaring_types.h"  // roaring_iterator
#include "bluebird/bits/roaring/array_util.h"  // binarySearch()/memequals() for inlining

#include "container_defs.h"  // container_t, perfparameters
